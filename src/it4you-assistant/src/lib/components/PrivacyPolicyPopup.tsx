    ...
    return (
        <div className="popup-overlay">
            <div className="popup-content">
                ...
                <p>
                    We use OpenAI to provide certain features on this website. By continuing, you agree to the use of
                    OpenAI services and acknowledge that your data may be processed in accordance with our privacy
                    policy and OpenAI's privacy policy.
                </p>
